...
from routes import chat, models, settings as settings_route, conversations as conversations_route, pro_route as pro_route
...
app.include_router(pro_route.router, dependencies=[Depends(verify_token)])
